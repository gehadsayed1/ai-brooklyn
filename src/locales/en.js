export default {
  ...
  whyUs: {
    title: "Why Us?",
    description:
      "Empowering your business with AI-driven strategies, automation, and advanced tech.",
    items: {
      quality: {
  ...
  footer: {
    companyInfo:
      "Empowering your business through smart, AI-driven solutions in web development, automation, and data intelligence.",
