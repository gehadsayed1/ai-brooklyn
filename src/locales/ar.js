export default {
    ...
    business_ai: {
      ...
      services: {
        veo: {
          title:"Ai Chatbot",
          desc: "نصم حلول الذكاء الاصطناعي لتحسين إنتاجية العملاء، وتحسين العلاقات مع العملاء، وتحسين إنتاجية الموظفين.",
        },
        task: {
    ...
    services: {
      ...
      "video-ai": {
        title: "Ai Chatbot",
        description: "تواصل بذكاء مع عملائك على مدار الساعة. الـ AI Chatbot يدمج قوة الذكاء الاصطناعي ليوفر محادثات طبيعية، دعم فوري، وتجربة تفاعلية ترتقي بعملك لمستوى جديد.",
        details: "",
        features: [
          "توليد مشاهد واقعية",
